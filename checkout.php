...
<div class="container">
  ...
  <section class="py-5">
    ...
    <div class="row">
      <div class="col-lg-8">
        <form action="functions/orders/check_form.php" method="post">
          <div class="row">

            <div class="col-lg-6 form-group">
              <label class="text-small text-uppercase" for="firstName">First name</label>
              <input class="form-control form-control-lg" name="f_name" id="firstName" type="text" placeholder="Enter your first name" value="<?= isset($_SESSION["values"]["f_name"]) ? $_SESSION["values"]["f_name"] : explode(" ", $user["username"])[0] ?>">
              <?php if (in_array("f_name", $_SESSION["error"])) { ?>
                <div class="text-danger d-flex align-items-center">
                  <i class="fas fa-exclamation-triangle mr-3"></i>
                  <div>
                    you have to write you'r first name
                  </div>
                </div>
              <?php } ?>
            </div>
            <div class="col-lg-6 form-group">
              ...
              <input class="form-control form-control-lg" name="l_name" id="lastName" type="text" placeholder="Enter your last name" value="<?= isset($_SESSION["values"]["l_name"]) ? $_SESSION["values"]["l_name"] : explode(" ", $user["username"])[1] ?>">
              <?php if (in_array("l_name", $_SESSION["error"])) { ?>
                <div class="text-danger d-flex align-items-center">
                  <i class="fas fa-exclamation-triangle mr-3"></i>
                  <div>
                    you have to write you'r last name
                  </div>
                </div>
              <?php } ?>
            </div>
            <div class="col-lg-6 form-group">
              ...
              <input class="form-control form-control-lg" name="email" id="email" type="email" placeholder="e.g. Jason@example.com" value="<?= isset($_SESSION["values"]["email"]) ? $_SESSION["values"]["email"] : $user["email"] ?>">
              <?php if (in_array("email", $_SESSION["error"])) { ?>
                <div class="text-danger d-flex align-items-center">
                  <i class="fas fa-exclamation-triangle mr-3"></i>
                  <div>
                    you have to write you'r email address
                  </div>
                </div>
              <?php } ?>
            </div>
            <div class="col-lg-6 form-group">
              ...
              <input class="form-control form-control-lg" name="phone" id="phone" type="tel" placeholder="e.g. +02 245354745" value="<?= isset($_SESSION["values"]["phone"]) ? $_SESSION["values"]["phone"] : $user["phone"] ?>">
              <?php if (in_array("phone", $_SESSION["error"])) { ?>
                <div class="text-danger d-flex align-items-center">
                  <i class="fas fa-exclamation-triangle mr-3"></i>
                  <div>
                    you have to write you'r phone number
                  </div>
                </div>
              <?php } ?>
            </div>
            <div class="col-lg-6 form-group">
              ...
              <input class="form-control form-control-lg" name="company" id="company" type="text" placeholder="Your company name" value="<?= isset($_SESSION["values"]["company"]) ? $_SESSION["values"]["company"] : "" ?>">
            </div>
            <div class="col-lg-6 form-group">
              <label class="text-small text-uppercase" for="country">Country</label>
              <select class="selectpicker country" name="country" id="country" data-width="fit" data-style="form-control form-control-lg" data-title="Select your country">
                <?php if (isset($_SESSION["values"]["country"]) && $_SESSION["values"]["country"] != "") { ?>
                  <option value='<?= $_SESSION["values"]["country"] ?>' selected><?= $_SESSION["values"]["country"] ?></option>
                  <?php } else { ?>
                  <option value='<?= $user["country"] ?>' selected>Egypt</option>
                <?php } ?>
              </select>
              <?php if (in_array("country", $_SESSION["error"])) { ?>
                <div class="text-danger d-flex align-items-center">
                  <i class="fas fa-exclamation-triangle mr-3"></i>
                  <div>
                    you have to select you'r country
                  </div>
                </div>
              <?php } ?>
            </div>
            <div class="col-lg-12 form-group">
              ...
              <input class="form-control form-control-lg" name="address_1" id="address" type="text" placeholder="House number and street name" value="<?= isset($_SESSION["values"]["address_1"]) ? $_SESSION["values"]["address_1"] : $user["address_1"] ?>">
              <?php if (in_array("address_1", $_SESSION["error"])) { ?>
                <div class="text-danger d-flex align-items-center">
                  <i class="fas fa-exclamation-triangle mr-3"></i>
                  <div>
                    you have to write you'r address
                  </div>
                </div>
              <?php } ?>
            </div>
            <div class="col-lg-12 form-group">
              <label class="text-small text-uppercase" for="addressalt">Address line 2</label>
              <input class="form-control form-control-lg" name="address_2" id="addressalt" type="text" placeholder="Apartment, Suite, Unit, etc (optional)" value="<?= isset($_SESSION["values"]["address_2"]) ? $_SESSION["values"]["address_2"] : $user["address_2"] ?>">
            </div>
            <div class="col-lg-6 form-group">
              <label class="text-small text-uppercase" for="city">Town/City</label>
              <input class="form-control form-control-lg" name="city" id="city" type="text" value="<?= isset($_SESSION["values"]["city"]) ? $_SESSION["values"]["city"] : $user["city"] ?>">
              <?php if (in_array("city", $_SESSION["error"])) { ?>
                <div class="text-danger d-flex align-items-center">
                  <i class="fas fa-exclamation-triangle mr-3"></i>
                  <div>
                    you have to write you'r city
                  </div>
                </div>
              <?php } ?>
            </div>
            <div class="col-lg-6 form-group">
              ...
              <input class="form-control form-control-lg" name="county" id="state" type="text" value="<?= isset($_SESSION["values"]["county"]) ? $_SESSION["values"]["county"] : $user["county"] ?>">
              <?php if (in_array("county", $_SESSION["error"])) { ?>
                <div class="text-danger d-flex align-items-center">
                  <i class="fas fa-exclamation-triangle mr-3"></i>
                  <div>
                    you have to write you'r county
                  </div>
                </div>
              <?php } ?>
            </div>
          ...
          <div class="card-body">
            ...
            <ul class="list-unstyled mb-0">
              ...
              foreach ($carts as $cart) :
                $myId++;
                $product = $conn->query("SELECT * FROM products where id='$cart[pro_id]'")->fetch_assoc();
                $img = $conn->query("SELECT * FROM images where pro_id='$product[id]'")->fetch_assoc();

                $total += $product["price"] * $cart["count"];
              ?>
                <li class="d-flex align-items-center justify-content-between"><strong class="small font-weight-bold"><?= $product["name"] ?></strong><span class="text-muted small">$<?= $product["price"] * $cart["count"] ?></span></li>
